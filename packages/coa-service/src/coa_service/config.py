...
class COASettings(SharedSettings):
    default_coa_accounts: list[dict] = [
        ...
        {"code": "1200", "name": "Accounts Receivable", "type": "asset", "description": "Trade receivables"},
        {"code": "2000", "name": "Accounts Payable", "type": "liability", "description": "Short-term payables"},
        ...
        {"code": "5000", "name": "Operating Expenses", "type": "expense", "description": "General operating expenses"},
    ]
